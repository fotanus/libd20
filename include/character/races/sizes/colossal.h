...
#ifndef INCLUDE_CHARACTER_RACES_SIZES_COLOSSAL_H_
#define INCLUDE_CHARACTER_RACES_SIZES_COLOSSAL_H_
...
#endif  // INCLUDE_CHARACTER_RACES_SIZES_COLOSSAL_H_
