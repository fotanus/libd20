#ifndef INCLUDE_CHARACTER_RACES_SIZES_DIMINUTIVE_H_
#define INCLUDE_CHARACTER_RACES_SIZES_DIMINUTIVE_H_
...
#endif  // INCLUDE_CHARACTER_RACES_SIZES_DIMINUTIVE_H_
